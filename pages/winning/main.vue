...
<template>
	<div class="winning_body">
		<div class="body_bg">
			<image mode="widthFix" src="https://image.etcchebao.com/etc-min/winning-body-bg.jpg" />
		</div>
		...
		<div class="winning_duct">
			...
			<div class="duct_box">
				<div class="warp">
					...
					<image src="https://image.etcchebao.com/etc-min/winning-duct-2499.png" />
		...
		<div class="card_box">
			<image mode="widthFix" src="https://image.etcchebao.com/etc-min/winning-cont-2.png" />
		</div>
		...
		<div class="barrage">
			<ul class="barrage-list">
				<li v-for="(item, index) in barrages" :key="index" class="barrage-item" :class="[item.css]">
