  ...
  <view class="act">
    <view class="act-box">
      ...
      <block v-if="totalCoins > 0">
        <image
          src="https://image.etcchebao.com/etc-min/coin10.png"
          v-if="totalCoins <= 10"
          class="bottle-coin"
        />

        <image
          v-else-if="totalCoins > 10 && totalCoins <= 100"
          src="https://image.etcchebao.com/etc-min/coin100.png"
          class="bottle-coin"
        />
        <image
          v-else-if="totalCoins > 100"
          src="https://image.etcchebao.com/etc-min/coin100-later.png"
          class="bottle-coin"
        />
      </block>
