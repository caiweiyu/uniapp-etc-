...
@import '../common/index.css';.vant-goods-action-button-index {
  flex: 1;
}
.van-goods-action-button {
  --button-warning-background-color: linear-gradient(to right, #ffd01e, #ff8917);
  --button-warning-background-color: var(--goods-action-button-warning-color, linear-gradient(to right, #ffd01e, #ff8917));
  --button-danger-background-color: linear-gradient(to right, #ff6034, #ee0a24);
  ...
  --button-default-height: var(--goods-action-button-height, 80rpx);
  --button-line-height: 80rpx;
  --button-line-height: var(--goods-action-button-height, 80rpx);
...
.van-goods-action-button--first {
  margin-left: 10rpx;
  --button-border-radius: 40rpx 0 0 40rpx;
  --button-border-radius: var(--goods-action-button-border-radius, 40rpx) 0 0 var(--goods-action-button-border-radius, 40rpx);
}
.van-goods-action-button--last {
  margin-right: 10rpx;
  --button-border-radius: 0 40rpx 40rpx 0;
  --button-border-radius: 0 var(--goods-action-button-border-radius, 40rpx) var(--goods-action-button-border-radius, 40rpx) 0;
}
.van-goods-action-button--first.van-goods-action-button--last {
  --button-border-radius: 40rpx;
  --button-border-radius: var(--goods-action-button-border-radius, 40rpx);
}
