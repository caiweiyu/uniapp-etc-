...
@import '../common/index.css';.van-search {
  display: flex;
  align-items: center;
  box-sizing: border-box;
  padding: 20rpx 24rpx;
  padding: var(--search-padding, 20rpx 24rpx);
}
.van-search__content {
  display: flex;
  flex: 1;
  padding-left: 16rpx;
  padding-left: var(--padding-xs, 16rpx);
  border-radius: 4rpx;
...
.van-search__content--round {
  border-radius: calc(68rpx / 2);
  border-radius: calc(var(--search-input-height, 68rpx) / 2);
}
.van-search__label {
  padding: 0 10rpx;
  padding: var(--search-label-padding, 0 10rpx);
  font-size: 28rpx;
  font-size: var(--search-label-font-size, 28rpx);
  line-height: 68rpx;
  line-height: var(--search-input-height, 68rpx);
  color: #323233;
...
.van-search__action {
  padding: 0 16rpx;
  padding: var(--search-action-padding, 0 16rpx);
  font-size: 28rpx;
  font-size: var(--search-action-font-size, 28rpx);
  line-height: 68rpx;
  line-height: var(--search-input-height, 68rpx);
  color: #323233;
