...
@import '../common/index.css';.van-checkbox {
  display: flex;
  align-items: center;
  overflow: hidden;
  user-select: none;
...
.van-checkbox__label {
  line-height: 40rpx;
  line-height: var(--checkbox-size, 40rpx);
}
.van-checkbox__icon-wrap {
  flex: none;
}
.van-checkbox__icon {
  ...
  font-size: 40rpx;
  font-size: var(--checkbox-size, 40rpx);
  border: 2rpx solid #c8c9cc;
  border: 2rpx solid var(--checkbox-border-color, #c8c9cc);
...
.van-checkbox__label {
  ...
  margin-left: 20rpx;
  margin-left: var(--checkbox-label-margin, 20rpx);
  color: #323233;
...
.van-checkbox__label--left {
  float: left;
  margin: 0 20rpx 0 0;
  margin: 0 var(--checkbox-label-margin, 20rpx) 0 0;
}
