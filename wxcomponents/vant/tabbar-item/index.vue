...
@import '../common/index.css';.vant-tabbar-item-index {
  flex: 1;
}
.van-tabbar-item {
  display: flex;
  ...
  font-size: 24rpx;
  font-size: var(--tabbar-item-font-size, 24rpx);
  line-height: 1;
...
.van-tabbar-item__icon {
  position: relative;
  margin-bottom: 10rpx;
  margin-bottom: var(--tabbar-item-margin-bottom, 10rpx);
  font-size: 36rpx;
  font-size: var(--tabbar-item-icon-size, 36rpx);
}
