...
@import '../common/index.css';.van-switch {
  position: relative;
  ...
  border: var(--switch-border, 2rpx solid rgba(0, 0, 0, 0.1));
  border-radius: 1em;
...
.van-switch__node {
  ...
  box-shadow: var(--switch-node-box-shadow, 0 6rpx 2rpx 0 rgba(0, 0, 0, 0.05), 0 4rpx 4rpx 0 rgba(0, 0, 0, 0.1), 0 6rpx 6rpx 0 rgba(0, 0, 0, 0.05));
  transition: transform 0.3s cubic-bezier(.3, 1.05, .4, 1.05);
  transition: transform var(--switch-transition-duration, 0.3s) cubic-bezier(.3, 1.05, .4, 1.05);
}
.van-switch__loading {
